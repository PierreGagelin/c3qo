...
CMAKE_OPTIONS="$CMAKE_OPTIONS -DC3QO_ZEROMQ_BUILD:STRING=$C3QO_DIR_TOOLS/zeromq-4.3.0-build"
CMAKE_OPTIONS="$CMAKE_OPTIONS -DC3QO_ZEROMQ:STRING=$C3QO_DIR_TOOLS/zeromq-4.3.0"
